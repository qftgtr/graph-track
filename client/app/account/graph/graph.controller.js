...
class GraphController {
  constructor($state) {
    this.GraphTrackForceLayout = GraphTrackForceLayout;
    const width = $('.gt-d3-target').width();
    const gt = GraphTrackForceLayout('.gt-d3-target', width, 640);
    gt.render('/api/track/graph?appVersion=0.1&appId='+$state.params.id);
  }
}
...
function GraphTrackForceLayout(target, width, height) {  
