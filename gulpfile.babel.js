// Generated on 2016-03-12 using generator-angular-fullstack 3.4.1
'use strict';
...
gulp.task('inject', cb => {
    runSequence(['inject:js', 'inject:css', 'inject:css'], cb);
});
